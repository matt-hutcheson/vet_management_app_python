...
# Client repo tests
client_1 = Client("James", "McBean", "07666 666 666", "Baberton Mains Row, Edinburgh, EH12 1LS", True)
client_2 = Client("Daniel", "Jackson", "07888 888 888", "Duke Street, Glasgow, G5 2FH", False)
